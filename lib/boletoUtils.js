...
const SacadorAvalista = (function () {
	function SacadorAvalista() {

	}

	SacadorAvalista.prototype.getNome = function () {
		return this._nome;
	};
	SacadorAvalista.prototype.comNome = function (_nome) {
		this._nome = _nome;
		return this;
	};

	SacadorAvalista.prototype.getIdentificacao = function () {
	...
	SacadorAvalista.prototype.getRegistroNacional = function () {
		return this._registroNacional;
	};

	SacadorAvalista.prototype.getRegistroNacionalFormatado = function () {
		return formatacoes.registroNacional(this._registroNacional);
	};

	SacadorAvalista.prototype.temRegistroNacional = function () {
		return validacoes.eRegistroNacional(this._registroNacional);
	};

	SacadorAvalista.prototype.comCNPJ = function (_cnpj) {
		this.comRegistroNacional(_cnpj);
		return this;
	};

	SacadorAvalista.prototype.comCPF = function (_cpf) {
		this.comRegistroNacional(_cpf);
		return this;
	};

	SacadorAvalista.prototype.comRegistroNacional = function (_registroNacional) {
		this._registroNacional = _registroNacional;
		return this;
	};

	SacadorAvalista.prototype.getDocumento = function () {
		return this._documento;
	};

	SacadorAvalista.prototype.comDocumento = function (_documento) {
		this._documento = _documento;
		return this;
	};

	SacadorAvalista.novoSacadorAvalista = function () {
		return new SacadorAvalista();
	};

	return SacadorAvalista;
});

module.exports.SacadorAvalista = SacadorAvalista;
...
var Boleto = (function () {
	...
	Boleto.prototype.comDescricoes = function (_descricoes) {
		...
		/* if (_descricoes.length > 5) {
			throw new Error('Máximo de cinco descrições permitidas');
		} */
	...
	Boleto.prototype.getSacadorAvalista = function () {
		return this._sacadorAvalista;
	};

	Boleto.prototype.comSacadorAvalista = function (_sacadorAvalista) {
		this._sacadorAvalista = _sacadorAvalista;
		return this;
	};
